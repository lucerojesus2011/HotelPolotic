...
<H1>Datos de Ingreso </h1> 
        <form action="SvAltaEmpleado" method="post">
           ...
           <p>Nombre:  	<input type="text" name="EmpleadoNombre"> </p>
           <p>Apellido: <input type="text" name="EmpleadoApellido">  </p>
           <p>Dni: 		<input type="text" name="EmpleadoDni"> </p>
           <p>Cargo:  	<input type="text" name="EmpleadoCargo"> </p>
           <p>Fecha de nacimiento: <input type="date" name="EmpleadoNacimiento" >  </p>
           <p>Direccion: 		<input type="text" name="EmpleadoDireccion"> </p>
