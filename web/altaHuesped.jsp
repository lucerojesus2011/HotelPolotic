...
<H1>Datos de Ingreso </h1> 
        <form action="SvAltaHuesped" method="post">
           ...
           <p>Nombre:  	<input type="text" name="HuespedNombre"> </p>
           <p>Apellido: <input type="text" name="HuespedApellido">  </p>
           <p>Dni: 		<input type="text" name="HuespedDni"> </p>
           <p>Profesion:  	<input type="text" name="HuespedProfesion"> </p>
           <p>Fecha de nacimiento: <input type="date" name="HuespedNacimiento" >  </p>
           <p>Direccion: 		<input type="text" name="HuespedDireccion"> </p>
