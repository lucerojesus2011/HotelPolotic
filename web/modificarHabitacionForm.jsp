...
<H1>Modificar Empleado</h1> 
        <form action="SvAltaEmpleado" method="post">
           ...
           <p>ID: <input type="text" name="EmpleadoId" value="<%= request.getSession().getAttribute("empleadoId") %>" disabled> </p> 
           <p>Nombre:  	<input type="text" name="EmpleadoNombre" value="<%= request.getSession().getAttribute("empleadoNombre") %>"> </p>
           <p>Apellido: <input type="text" name="EmpleadoApellido" value="<%= request.getSession().getAttribute("empleadoApellido") %>">  </p>
           <p>Dni: 		<input type="text" name="EmpleadoDni" value="<%= request.getSession().getAttribute("empleadoDni") %>"> </p>
           <p>Cargo:  	<input type="text" name="EmpleadoCargo" value="<%= request.getSession().getAttribute("empleadoCargo") %>"> </p>
           <p>Fecha de nacimiento: <input type="date" name="EmpleadoNacimiento" value="<%= request.getSession().getAttribute("empleadoNacimiento") %>" >  </p>
           <p>Direccion: 		<input type="text" name="EmpleadoDireccion" value="<%= request.getSession().getAttribute("empleadoDireccion") %>"> </p>
