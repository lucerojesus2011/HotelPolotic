...
<H1>Datos de Ingreso </h1> 
        <form action="SvAltaEmpleado" method="post">
           ...
           <p>Nombre:  	<input type="text" name="HabitacionNombre"> </p>
           <p>Tipo: <input type="text" name="HabitacionTipo">  </p>
           <p>Cantidad de Personas: 		<input type="text" name="HabitacionCantidad"> </p>
           <p>Precio:  	<input type="text" name="HabitacionPrecio"> </p>
           <p>Piso: <input type="text" name="HabitacionPiso" >  </p>
